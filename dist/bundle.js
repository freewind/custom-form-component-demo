...
const getValue = (values, statePath) => {
    const inputValue = formik_1.getIn(values, statePath);
    return inputValue && inputValue.toString();
};
exports.MyCustomComponent = (props) => {
    ...
    return (react_1.default.createElement("div", null,
        react_1.default.createElement("div", null,
            react_1.default.createElement("label", null,
                label,
                react_1.default.createElement("input", { type: 'text', value: value, onChange: event => onChange(event.target.value) }))),
        react_1.default.createElement("div", null,
            react_1.default.createElement("label", null,
                react_1.default.createElement("input", { type: 'radio', checked: true }),
                "Or"),
            react_1.default.createElement("label", null,
                react_1.default.createElement("input", { type: 'radio' }),
                "Not"))));
};
exports.MyCustomComponent.displayName = 'MyCustomComponent';
const connectedComponent = formik_1.connect(exports.MyCustomComponent);
